...
void QNA_tool::query_llm(string filename1, string filename2, string one_more_file, Node* root, int k, string API_KEY_GPT, string API_KEY_PALM, string question, string filename3, string email, string pswd){
    ...
    fhandle1 << "I am giving you 5 paragraphs. I want you to output from the given 5 paragraphs lines relevant to the user query. DO NOT PROVIDE YOUR OWN COMMENTS OR OPINIONS. YOU ARE NOT PERMITTED TO USE INTERNET OR ANY OTHER DATABASE to answer the query. Only use the given five paragraphs as source. ";
    fhandle1.close();
    string cmd2 = "python3 ";
    cmd2 += filename2;
    cmd2 += " ";
